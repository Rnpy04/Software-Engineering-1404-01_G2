...
class FreeAIService:
    ...
    def extract_tags(self, text: str, title: str = "") -> List[str]:
        ...
        stopwords = [
            # افعال ساده و رایج
            "است", "بوده","بود", "شد", "شده", "می‌کند", "می‌شود", "دارند", "داشت", "داشتند", "کند", "کنند", "کرد", "کرده", "خواهد", "باشد",
            "می‌باشد", "شاید", "خواهد شد", "می‌کرد", "می‌کردند",
            
            # حروف اضافه و ربط
            "و", "یا", "به", "از", "در", "با", "برای", "تا", "که", "اما", "اگر", "چون", "نیز", "ولی", "هر", "این", "آن", "آنکه", "اگرچه",
            
            # پسوندها و پیشوندهای رایج
            "ها", "های", "ترین", "تر", "ی", "ای", "ایم", "اند", "تان", "شان", "ام", "ات", "اش",
            
            # ضمایر و کلمات کوتاه
            "من", "تو", "او", "ما", "شما", "آنها", "خود", "هم", "اینها", "کسی", "هیچ", "همه", "چنین", "چطور", "چه", "چرا", "چقدر",
            
            # کلمات کم‌ارزش دیگر
            "بر", "را", "همچنین", "بعد", "قبل", "چیز", "مثلا", "مثل", "یکی", "بسیار", "کم", "زیاد"
        ]
